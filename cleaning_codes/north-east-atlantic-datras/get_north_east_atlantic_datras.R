# Purpose:   Download and reformat DATRAS trawl survey data for growth analysis.
...
#
# Output:    cleaning_codes/north-east-atlantic-datras/merged_survey_data.rds
#            cleaning_codes/north-east-atlantic-datras/log_survey_data.rds
...
# -----------------------------------------------------------------------------
# This takes a while..
# download_datras(surveys = NULL, years = NULL, dir = paste0(home, "/raw_data/north-east-atlantic-datras/"))
...
survey_paths <- list.dirs(file.path(home, "raw_data/north-east-atlantic-datras"), recursive = FALSE)
...
saveRDS(results, file.path(home, "cleaning_codes/north-east-atlantic-datras/merged_survey_data.rds"))
saveRDS(run_log, file.path(home, "cleaning_codes/north-east-atlantic-datras/log_survey_data.rds"))
